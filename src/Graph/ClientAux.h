...
private:
    ...
    int index;
public:
    Vertex() : name(nullptr), data(0), index(0) {}
...
private:
    ...
    DATA data;
public:
    Edge(Vertex<DATA, NAME> *v1, Vertex<DATA, NAME> *v2) : v1(v1), v2(v2) { data = v1->getInd()*10+v2->getInd(); }
    Edge(Vertex<DATA, NAME> *v1, Vertex<DATA, NAME> *v2, WD w) : v1(v1), v2(v2), w(w) {}
